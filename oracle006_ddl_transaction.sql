...
FROM employees
WHERE 1=0;--테이블 구조만 복사하기위해 일부로 false

DESC emp01;--테이블구조확인

SELECT * FROM emp01; --데이터 있는지 확인
...
/*
    테이블의 내용을 수정
    UPDATE table_name
    SET cloumn_nam = value, column_name = value
    WHERE cloumn_name = value;
*/
...
/*
 DROP은 테이블아예 없애는거고 DELETE는 테이블안에 내용을 삭제하는거다

 테이블의 내용을 삭제
 DELETE FROM table_name
 WHERE column_name = value;
*/
--emp01테이블에서 first_name컬럼의 값이 'candy'일때 삭제하세요ㅗ
DELETE FROM emp01
...
--B 세션
-- A 세션이 commit이 되면 B세션은 해당 행에대한 Lock상태가 해제가 되면서 오류메세지 출력
